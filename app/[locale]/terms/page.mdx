...
These terms govern your use of our website or services such as 7QR, 7qr.codes, 7qr.codes, 7qr.sh (collectively, “Services”) and software that we include as part of the Services, including any applications, User Files (as defined below), scripts, instruction sets, and any related documentation (collectively “Software”). 
...
## 1.1 Choice of Law
Your relationship is with 7QR, a company incorporated under the laws of Switzerland, with its registered offices at 
...
Whilst using the Services, you will share information with 7QR about how you use our web application. This shared information is associated with your 7QR account and allows us to provide you with a more personalized experience, and helps us improve product quality and features.
...
The free trial only applies to new customers and may not be available for all services, regions, countries or currencies. 7QR reserves the right to remove or cancel the free trial offer at any time without any reason.

## 6.5 Lifetime Offer
The Lifetime Offer is a premium, one-time payment option that grants you unlimited access to specific services provided by 7QR for an unlimited period. This offer is designed to provide long-term value to our users who prefer a one-time investment over recurring subscriptions.

### Eligibility and Terms
The Lifetime Offer is available to both new and existing customers of 7QR.
...
Upon successful payment, you will gain unlimited access to the specified services without any additional fees or charges for the service period defined as "lifetime." Lifetime access is defined as the period during which the purchased services are available and supported by 7QR.
7QR reserves the right to modify, replace, or discontinue any services included in the Lifetime Offer. In the event that a service included in the Lifetime Offer is discontinued, 7QR will make reasonable efforts to provide a comparable replacement service. However, the nature and functionality of replacement services are at the sole discretion of 7QR.
...
In exceptional circumstances where a refund is issued at the discretion of 7QR, the refunded amount will be prorated based on the duration of service usage prior to the refund request.
...
The information and templates provided by 7QR (“we”, “us” or “our”) on www.7qr.codes ("website") and our mobile applications are provided for information purposes only. All information on the website is provided in good faith, however under no circumstance we shall have any liability to you as a result of your use and/or your reliance on the information, templates, Services or Software.

## 8.3 QR Codes
7QR offers QR Code generation services that allow users to create QR codes linking to various types of digital content. While we strive to ensure reliability and accessibility, we do not guarantee that QR codes generated through our service will be error-free, remain operational indefinitely, or be compatible across all devices and scanning applications. Users are responsible for ensuring that the content linked to QR codes complies with all applicable laws and regulations. 7QR disclaims any liability for QR codes that are used to link to unlawful, malicious, or inappropriate content. It is the user's responsibility to maintain and update their QR codes as necessary.

## 8.4 Short Links
Our Short Link service enables users to create shortened URLs that redirect to longer URLs. 7QR endeavors to ensure the reliability and functionality of shortened links but does not guarantee uninterrupted service. Users must ensure that the original URLs and the content they lead to do not violate any laws or infringe on any rights. 7QR is not liable for any misuse of the Short Link service, including the creation of links to harmful, illegal, or offensive content. We reserve the right to remove or disable short links that are found to be in violation of our terms of service without notice.

## 8.5 Analytics
7QR provides Analytics services for QR codes and Short Links, offering data such as the number of scans or clicks, geographic locations of users, and other usage statistics. While we strive to provide accurate and useful analytics, 7QR does not guarantee the completeness or accuracy of analytics data. Analytics are provided "as is" and should be used as a guide rather than definitive data. Users should not solely rely on 7QR Analytics for critical decisions without verification. 7QR disclaims any liability for decisions made based on analytics data provided by our services.
...
## 12.1 Process
For any concern or dispute you may have, you agree to first try to resolve the dispute informally by contacting us. If a dispute is not resolved within 30 days of submission, you or 7QR must resolve any claims relating to these terms, the Services, or the Software through final and binding arbitration, except that you or 7QR may assert claims before the courts of the Canton of Geneva, Switzerland.

## 12.2 Rules
If you or 7QR decide to resort to arbitration as per the foregoing paragraph, the Swiss Chambers’ Arbitration Institution will administer the arbitration in Geneva under the Swiss Rules of International Arbitration. There will be one arbitrator that you and 7QR both select. The arbitration will be conducted in the English language. Judgment upon the award rendered may be entered and will be enforceable in any court of competent jurisdiction having jurisdiction over the parties.
